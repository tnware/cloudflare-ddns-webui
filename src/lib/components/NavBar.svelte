...
<Navbar
	let:hidden
	let:toggle
	class="dark:bg-neutral-800 px-2 sm:px-4 py-2.5 w-full"
...
>
	...
	<NavUl {hidden}>
		<NavLi href="/" active={activeUrl === '/'}>Dashboard</NavLi>
		<!-- <NavLi href="/records/enabled" active={activeUrl === '/records/enabled'}>Active Records</NavLi> -->
		<NavLi href="/records" active={activeUrl === '/records'}>Records</NavLi>
		<NavLi href="/zones" active={activeUrl === '/zones'}>Zones</NavLi>
		<NavLi href="/logs" active={activeUrl === '/logs'}>Logs</NavLi>
		<NavLi href="/settings" active={activeUrl === '/settings'}>Settings</NavLi>
	</NavUl>
</Navbar>

...
<div
	class="opacity-80 dark:opacity-80 hover:dark:opacity-100 hover:opacity-100 hover:from-neutral-50 hover:dark:from-neutral-500 transition-all rounded-xl dark:bg-gradient-to-br bg-gradient-to-br dark:from-neutral-600 from-neutral-100 dark:via-neutral-800 via-neutral-100 dark:to-neutral-700 to-neutral-200"
>
	<!-- <a href="/records/{record.id}"> -->
	<div
		class="h-full w-full dark:bg-gradient-to-br dark:from-neutral-700 dark:to-neutral-800 rounded-xl back p-4 dark:text-white group"
	>
		<!-- Logo -->
		...
		<div class="flex justify-between">
			...
			<div id="end">
				<svg
					...
					fill="none"
					class="w-6 stroke-neutral-800 dark:stroke-neutral-500 transition-all group-hover:translate-x-1 group-hover:stroke-neutral-400"
